...
CREATE INDEX IF NOT EXISTS idx_preview_entitlements_browser_id
ON preview_entitlements(browser_id);

CREATE INDEX IF NOT EXISTS idx_preview_entitlements_ip_hash
ON preview_entitlements(ip_hash);
...
CREATE INDEX IF NOT EXISTS idx_preview_attempts_order_id
ON preview_attempts(order_id);

CREATE INDEX IF NOT EXISTS idx_preview_attempts_ip_hash
ON preview_attempts(ip_hash);
